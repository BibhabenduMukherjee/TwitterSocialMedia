...
function Profile() {
 const navigate = useNavigate();
  ...
  // Load all the posts when the component first mounts
  ...
  const handleImgUpload = async () => {
    ...
    const response =  axios.post(`${BASE_URL}/uploadFile`, formData)
  ...
  const addPost = async () => {
    ...
    if (image.preview === '') {
      ...
      console.log(imgRes)
      debugger
      const request = { description: caption, location: location, image: `${BASE_URL}/files/${imgRes.data.fileName}` }
    ...
    <div className='app'>
       ...
       <div className= "row ">
        ...
        <div className=' menu d-flex align-items-center flex-column '>
          ...
          <a href='/Home' className='home_icon mx-1'> <i class="fa-solid fa-house"></i></a>
            <p className='home'>Home</p>
          </Link>
         
          <Link className='d-flex text-decoration-none ' to={`/profile/${user._id}`}>
          <a href= {`/profile/${user._id}`} className='home_icon mx-1'> <i class="fa-solid fa-user"></i></a>
            <p className='home'>Profile</p>
          </Link>
          <div className='d-flex '>
          <Link className='d-flex text-decoration-none ' to={"/logout"}>
          <a href='/Logout' className='home_icon mx-1'><i class="fa-solid fa-right-from-bracket"></i></a>
        ...
        <div className=' leftsideBottom  shawdow d-flex  flex-column  '>
          <div className='d-flex justify-content-center align-items-center '>
            <img style={{borderRadius : 50}} src= {loggedUserpic} width={40} height= {40} />
            <div className='p-2'>{user_info.fullname}</div>
          </div>
        ...
        <h5>Home</h5>
        <button  onClick={handlePostShow} className=' buutt btn-feed  p-2'>Add Tweet</button>
        </div>
              ...
              <div className='row'>
                <div className='col-sm-12 mb-3'>
                  <div className="form-floating">
                    ...
                    <label for="floatingTextarea">Add Tweet</label>
                  </div>
                </div>
